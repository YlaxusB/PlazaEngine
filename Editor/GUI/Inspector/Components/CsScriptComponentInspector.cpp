...
namespace Plaza::Editor {
	void ComponentsInspector::CsScriptComponentInspector(Scene* scene, Entity* entity) {
		CsScriptComponent* scriptComponent = scene->GetComponent<CsScriptComponent>(entity->uuid);
