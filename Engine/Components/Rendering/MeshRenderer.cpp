...
namespace Plaza {
	MeshRenderer::MeshRenderer(Plaza::OpenGLMesh initialMesh, bool addToScene) {
	...
	MeshRenderer::MeshRenderer(Plaza::OpenGLMesh initialMesh, Material material, bool addToScene) {
		this->uuid = Plaza::UUID::NewUUID();
